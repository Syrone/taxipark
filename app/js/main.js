...
/* harmony import */ var _components_calculation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/calculation.js */ "./src/js/components/calculation.js");
/* harmony import */ var _components_calculation_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_calculation_js__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _components_swipers_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/swipers.js */ "./src/js/components/swipers.js");
/* harmony import */ var _components_modals_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/modals.js */ "./src/js/components/modals.js");
...
/* harmony import */ var _components_yandex_map_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/yandex-map.js */ "./src/js/components/yandex-map.js");
/* harmony import */ var _components_yandex_map_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_components_yandex_map_js__WEBPACK_IMPORTED_MODULE_9__);
...
choicesElements?.forEach(element => {
  const choices = new choices_js__WEBPACK_IMPORTED_MODULE_0__["default"](element, config);
});
...
init();
window.addEventListener('resize', (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(() => {
  (0,_functions_header_height__WEBPACK_IMPORTED_MODULE_0__.getHeaderHeight)();
  handleScroll();
}));
window.addEventListener('scroll', (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(handleScroll));
...
swiperCards?.forEach(element => {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](element, {
    slidesPerView: 3,
    spaceBetween: 20,
    grabCursor: true,
    breakpoints: {
...
cardTabs?.forEach(element => {
  if (element) {
    const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('tabs-card');
  }
});
...
function init() {
  ...
  var placemarks = [new ymaps.Placemark([55.579653, 37.591072], {}, {
...
(function () {
  ...
  burger?.addEventListener('click', e => {
    ...
    if (menu?.classList.contains('menu--active')) {
      ...
      scroll_lock__WEBPACK_IMPORTED_MODULE_0___default().disablePageScroll(menu);
    } else {
      burger?.setAttribute('aria-expanded', 'false');
      overlay?.setAttribute('data-menu-overlay', 'false');
      burger?.setAttribute('aria-label', 'Открыть меню');
      scroll_lock__WEBPACK_IMPORTED_MODULE_0___default().enablePageScroll(menu);
    }
  });
